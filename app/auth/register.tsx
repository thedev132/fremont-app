    ...
    <PaperProvider>
      <View style={{ alignItems: "center", justifyContent: "center", flex: 1 }}>
        <View style={{ width: 300, marginTop: 30 }}>
          <Text className="text-3xl text-center font-bold mb-10">
            Registration
          </Text>
          <TextInput
            mode="outlined"
          ...
          <TouchableOpacity onPress={() => handleLoginPress()}>
            ...
            >
              <Text className="text-white text-xl ml-3 font-bold">
                Register
              </Text>
            </View>
          </TouchableOpacity>
          ...
          >
            <Text className="text-gray-600 text-md mt-5 text-center mb-5">
