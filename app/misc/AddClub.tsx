...
export default function AddClubScreen({ navigation }) {
            ...
            <Card style={{
                ...
                <TouchableOpacity onPress={() => navigation.navigate('misc/ClubDetails', {
                    ...
                    <View style={{ flexDirection: 'row', alignItems: 'center', flexWrap: 'wrap' }}>
                        <Text style={{ fontSize: 16, fontWeight: 'bold', flexShrink: 1 }} numberOfLines={2}>{item.getName()}</Text>
    ...
    const myRenderItem = ({ item }: { item: NestedOrganization }) => {
        ...
        // Find the corresponding full organization data from the filtered list
